...
class TranslateService:
    ...
    #                 src_lang=LanguagesConfig.en.code,
    ...
    #         key = f"{LanguagesConfig.en.code}-{dst_lang}-tag"
    #         for item in res:
    ...
    #                         LanguagesConfig.en.code, dst_lang.code, part
    #                     )
    #                     d[part] = _trans
    ...
    #                 and dst_lang in LanguagesConfig.fixed_lang
    #             ):
    ...
    #     return
    #     en = LanguagesConfig.en
    #     zh = LanguagesConfig.zh
    #     for dst_lang, service in self.services.items():
    #         # 只管泰语，韩文和俄语
    #         if dst_lang not in LanguagesConfig.fixed_lang:
    #             continue
    #         res = (
    #             self.db.query_by_condition(
    #                 src_lang=en.code,
    ...
    #     for src_lang in LanguagesConfig.src_langs:
    #         for dst_lang, service in self.services.items():
    #             key = f"{src_lang}_{dst_lang}"
    #             # 从数据库中查找
    #             res = self.app.get_or_default(key)
    #             log.debug(f"{key}:{res}")
    #             if res:
    ...
    #         for dst_lang, service in self.services.items():
    #             key = f"{src_lang}_{dst_lang}"
    #             glossary_id = self.app.get_or_default(key)
    #             if glossary_id:
