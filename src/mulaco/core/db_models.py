...
class ExcelSheet(Base):
    ...
    delete: Mapped[bool] = mapped_column(comment="软删除", default=False)
...
class CellInfo(Base):
    ...
    def __repr__(self) -> str:
        return f"<CellInfo(id={self.id}, exid={self.exsh_id}, loc({self.row}, {self.col}), lang={self.src_lang}, text={self.raw_text})>"
